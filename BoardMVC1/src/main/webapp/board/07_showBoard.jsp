	...
	<div id="wrapper" class="toggled">
			...
			<div class="container-fluid">
				<form method="post" action="05_updateBoard.jsp?no=<%=no%>">
					<table border="1">
						<tr>
							<td>번호</td>
							<td colspan="3" style="text-align: left;"><%=bdao.getBoard(no).getNo()%></td>
						</tr>
						<tr>
							<td>작성자</td>
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="updateSubject"
								value=<%=bdao.getBoard(no).getSubject()%> readonly /></td>
						</tr>

						<tr>
							<td>내용</td>
							<td colspan="3"><textarea name="updateContents" rows="10"
									cols="50" readonly><%=bdao.getBoard(no).getContents()%></textarea></td>
						</tr>
					</table>
		...
		<script>
			...
			delBoard.addEventListener('click', ()=>{
			    location.href = '06_deleteBoardPro.jsp?no=<%=no%>';
			})
